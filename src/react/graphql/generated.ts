...
export type QuoteCoverage = {
  ...
  coveredVins: Array<Scalars['String']>;
  declined: Scalars['Boolean'];
  /** Fetches an object given its ID. */
  node?: Maybe<Node>;
  /** Fetches a list of objects given a list of IDs. */
  nodes: Array<Maybe<Node>>;
  symbol: QuoteCoverageSymbol;
};


export type QuoteCoverageNodeArgs = {
  id: Scalars['ID'];
};


export type QuoteCoverageNodesArgs = {
  ids: Array<Scalars['ID']>;
};

export enum QuoteCoverageSymbol {
  /** Bodily Injury */
  Bi = 'bi',
  /** Bodily Injury/Property Damage Combined */
  BiPdCombined = 'bi_pd_combined',
...
export type PolicyholderAccountPolicyFragment = { __typename?: 'PolicyholderAccount', id: string, profile: { __typename: 'InsuredProfile', id: string }, policy: { __typename: 'ActivePolicy', effectiveDate: any, expirationDate: any, id: string, number: string, partnerBroadcasted: boolean, primaryNamedInsured: { __typename?: 'NamedInsured', id: string, firstName: string, lastName: string }, namedInsureds: Array<{ __typename?: 'NamedInsured', id: string, firstName: string, lastName: string }> } | { __typename: 'ExpiredPolicy', effectiveDate: any, expirationDate: any, id: string, number: string, partnerBroadcasted: boolean, primaryNamedInsured: { __typename?: 'NamedInsured', id: string, firstName: string, lastName: string }, namedInsureds: Array<{ __typename?: 'NamedInsured', id: string, firstName: string, lastName: string }> } | { __typename: 'FuturePolicy', effectiveDate: any, expirationDate: any, id: string, number: string, partnerBroadcasted: boolean, primaryNamedInsured: { __typename?: 'NamedInsured', id: string, firstName: string, lastName: string }, namedInsureds: Array<{ __typename?: 'NamedInsured', id: string, firstName: string, lastName: string }> } };
...
export type CompleteProfileMutation = { __typename?: 'Mutation', completeProfile?: { __typename?: 'CompleteProfilePayload', errors?: Array<string> | null, account?: { __typename?: 'ConsentedAccount', id: string, profile: { __typename: 'CompletedProfile', id: string, completed: boolean } | { __typename?: 'IncompleteProfile', id: string, completed: boolean, requiredFields?: Array<{ __typename: 'CheckboxFormInput', checked: boolean, disabled?: boolean | null, label?: string | null, required?: boolean | null, name: string } | { __typename: 'DateFormInput', disabled?: boolean | null, label?: string | null, maxDate?: any | null, minDate?: any | null, placeholder?: string | null, required?: boolean | null, selectedDate?: any | null, name: string } | { __typename: 'NumberFormInput', description?: string | null, disabled?: boolean | null, label?: string | null, maxValue?: number | null, minValue?: number | null, placeholder?: string | null, required?: boolean | null, name: string, numericValue?: number | null } | { __typename: 'SelectFormInput', disabled?: boolean | null, label?: string | null, required?: boolean | null, selectedOption?: string | null, name: string, options: Array<{ __typename?: 'InputOption', label: string, value: string }> } | { __typename: 'TextFormInput', description?: string | null, disabled?: boolean | null, label?: string | null, placeholder?: string | null, required?: boolean | null, value?: string | null, name: string }> | null } | { __typename?: 'InsuredProfile', id: string, completed: boolean } | { __typename?: 'RatedProfile', id: string, completed: boolean } } | { __typename?: 'PolicyholderAccount', id: string } | { __typename?: 'UnconsentedAccount', id: string } | null } | null };
